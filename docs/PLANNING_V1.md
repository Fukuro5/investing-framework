> **Archived — v1 plan, frozen.** Superseded by [PLANNING.md](../PLANNING.md) at the repo root, which now covers v2. Kept here for historical reference only — do not update.

# PLANNING.md — Investing Framework (v1, archived)
